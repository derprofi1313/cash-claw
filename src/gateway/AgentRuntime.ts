...
export class AgentRuntime {
  ...
  private buildExecutionSystemPrompt(): string {
    ...
    return [
      ...
      "",
      "Du kannst Tools aufrufen indem du JSON-BlÃ¶cke in deine Antwort einfÃ¼gst.",
      "Wenn du kein Tool brauchst, antworte direkt mit dem Ergebnis.",
      "",
      "Antwort-Format (wenn keine Tools nÃ¶tig):",
      "```json",
      "{",
      '  "thinking": "Dein Denkprozess bei dieser Aufgabe",',
      '  "result": "Das vollstÃ¤ndige Ergebnis (Text, Code, Analyse etc.)",',
      '  "summary": "Einzeilige Zusammenfassung fÃ¼r den Operator"',
      "}",
      "```",
      "",
      "Antwort-Format (wenn Tools benÃ¶tigt):",
      "```json",
      "{",
      '  "thinking": "Was ich vorhabe",',
      '  "actions": [',
      '    { "action": "tool", "tool": "gog.gmail.send", "params": { "to": "...", "subject": "...", "body": "..." } }',
      "  ],",
      '  "result": "ZusÃ¤tzlicher Output falls nÃ¶tig",',
